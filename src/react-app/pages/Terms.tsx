        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using Truebuddies' conversational assistant service, you agree to be
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Truebuddies provides a managed conversational assistant service that helps businesses
              capture leads, support customers, and escalate complex cases to human team members.
              We handle setup, monitoring, and ongoing iteration.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              To the maximum extent permitted by law, Truebuddies is not liable for indirect,
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              These terms are governed by the laws of the jurisdiction in which Truebuddies operates,
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="mailto:legal@truebuddies.com" className="text-blue-600 hover:text-blue-700">
                legal@truebuddies.com
              </a>
            </p>
          </section>
        </div>
