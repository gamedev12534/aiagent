      ...
      <section className="bg-gradient-to-br from-blue-50 via-purple-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Connect Truebuddies with your existing tools and workflows.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-purple-300 transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Send qualified leads directly to your CRM or spreadsheet with structured data.
              </p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• HubSpot</li>
                <li>• Salesforce</li>
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-green-300 transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Respond on the channels your customers prefer. Multi-channel support.
              </p>
              <ul className="space-y-2 text-sm text-gray-700">
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-orange-300 transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Get alerted when leads come in or escalations happen.
              </p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Slack</li>
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-red-300 transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Send automated follow-ups and lead summaries via email.
              </p>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• SendGrid</li>
                <li>• Mailgun</li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              A simple, reliable architecture that connects to your tools.
            </p>
          </div>
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200">
              ...
              <div className="mt-8 p-4 rounded-xl bg-blue-50 border border-blue-100">
                <p className="text-sm text-gray-700">
                  <strong>Data flow:</strong> Visitors interact with the assistant, which qualifies
                  them, answers questions, or escalates. Qualified leads go to your CRM, meetings
                  get booked on your calendar, and escalated cases create tickets in your helpdesk
                  - all automatically.
                </p>
              </div>
            </div>
