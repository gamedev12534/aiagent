      ...
      <section className="bg-gradient-to-br from-blue-50 via-purple-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose a plan based on agents, usage, and automations. Every plan includes onboarding,
            monitoring, and ongoing model updates.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-blue-300 transition-all">
              ...
              <p className="text-gray-600 mb-6">For teams launching their first RAG agent</p>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">2 data sources + 2 integrations</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">3 automation workflows</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 text-white relative border-2 border-transparent shadow-xl">
              ...
              <p className="text-blue-100 mb-6">For growing teams scaling multiple agents</p>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-300 flex-shrink-0 mt-0.5" />
                  <span>5 data sources + 5 integrations</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-300 flex-shrink-0 mt-0.5" />
            ...
            <div className="p-8 rounded-2xl bg-white border-2 border-gray-200 hover:border-purple-300 transition-all">
              ...
              <p className="text-gray-600 mb-6">For teams with custom agents and workflows</p>
              <div className="mb-6">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Unlimited data sources + integrations</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Unlimited automation workflows</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-white border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Agent Count</h3>
              <p className="text-gray-600">
                Each agent can have its own persona, data sources, and workflows. More agents
                increase storage and compute costs.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200">
              ...
              <p className="text-gray-600">
                Standard integrations (CRM, helpdesk, analytics) are included. Custom workflows and
                dedicated connectors may require additional setup fees.
              </p>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-gray-50">
              ...
              <p className="text-gray-600">
                No. Onboarding, knowledge ingestion, and initial tuning are included in your plan.
              </p>
            </div>
