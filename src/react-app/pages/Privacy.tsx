        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              Truebuddies ("we", "our", or "us") is committed to protecting your privacy. This
              Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you use our conversational assistant service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              <a href="mailto:privacy@truebuddies.com" className="text-blue-600 hover:text-blue-700">
                privacy@truebuddies.com
              </a>
            </p>
          </section>
        </div>
